...
pub struct MATCH_OUTPUT0<CTIMER>
where
    CTIMER: ctimer::Ctimer<Enabled>,
{
    pub _marker: PhantomData<CTIMER>,
}
pub struct MATCH_OUTPUT1<CTIMER>
where
    CTIMER: ctimer::Ctimer<Enabled>,
{
    pub _marker: PhantomData<CTIMER>,
}
pub struct MATCH_OUTPUT2<CTIMER>
where
    CTIMER: ctimer::Ctimer<Enabled>,
{
    pub _marker: PhantomData<CTIMER>,
}
pub struct MATCH_OUTPUT3<CTIMER>
where
    CTIMER: ctimer::Ctimer<Enabled>,
{
    pub _marker: PhantomData<CTIMER>,
