...
pub struct NoCs;
impl<SPI: Spi> SpiCsPin<NoPio, SPI> for NoCs {
    const CS: ChipSelect = ChipSelect::NoChips;
}
...
pub trait UsartTxPin<PIO, USART>
where
    PIO: PinId,
    USART: Usart,
{
...
pub trait UsartRxPin<PIO, USART>
where
    PIO: PinId,
    USART: Usart,
{
...
pub trait UsartRtsPin<PIO, USART>
where
    PIO: PinId,
    USART: Usart,
{
...
pub trait UsartCtsPin<PIO, USART>
where
    PIO: PinId,
    USART: Usart,
{
...
/// USART serial clock
pub trait UsartSclkPin<PIO, USART>
where
    PIO: PinId,
    USART: Usart,
{
...
impl<PIO1, PIO2, PIO3, PIO4, SPI, SCK, MISO, MOSI, CS> SpiPins<PIO1, PIO2, PIO3, PIO4, SPI>
    for (SCK, MOSI, MISO, CS)
where
    PIO1: PinId,
    PIO2: PinId,
    PIO3: PinId,
